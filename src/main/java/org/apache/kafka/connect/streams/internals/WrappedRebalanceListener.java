...
public class WrappedRebalanceListener implements ConsumerRebalanceListener {

    private ConsumerRebalanceListener rebalanceListener;

    public WrappedRebalanceListener(ConsumerRebalanceListener rebalanceListener) {
    ...
    public void onPartitionsRevoked(final Collection<TopicPartition> assignment) {
        rebalanceListener.onPartitionsRevoked(assignment);
    }
}
