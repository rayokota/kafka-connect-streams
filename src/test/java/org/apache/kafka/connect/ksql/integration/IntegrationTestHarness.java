...
import org.apache.kafka.connect.ksql.testutils.EmbeddedSingleNodeKafkaCluster;
import org.apache.kafka.connect.ksql.util.TestDataProvider;
import org.apache.kafka.connect.ksql.util.TopicConsumer;
...
public class IntegrationTestHarness {
    ...
    private static final Duration RESULTS_EXTRA_POLL_TIME_MS = Duration.ofMillis(250);
    ...
    public List<GenericRow> consumeDataToList(String topic,
                                              Schema schema,
                                              int expectedNumMessages,
        ...
        try (KafkaConsumer<?, GenericRow> consumer
            ...
            while (System.currentTimeMillis() < pollEnd &&
                ...
                for (ConsumerRecord<?, GenericRow> record :
            ...
            for (ConsumerRecord<?, GenericRow> record : consumer.poll(RESULTS_EXTRA_POLL_TIME_MS)) {
                if (record.value() != null) {
                    result.add(record.value());
                }
            }
